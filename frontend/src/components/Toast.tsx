...
export default function Toast({ tipo, titulo, mensagem }: Props) {
  return (
    <div className="pointer-events-none fixed right-4 top-20 z-50 w-full max-w-sm px-4 sm:px-0">
      <div
        className={
          tipo === 'sucesso'
            ? 'rounded-xl border border-green-200 bg-white p-4 shadow-lg shadow-green-100/70'
            : 'rounded-xl border border-red-200 bg-white p-4 shadow-lg shadow-red-100/70'
        }
      >
